...
public class CapitalismEnding {
    public static void capitalismEnding() {
        blank();
        System.out.println("                             당신은 성공적으로 좀비를 막았습니다.");
        blank();
        sec3();
        nextText();
        System.out.println("                           하지만 당신은 자본주의에 빠져들었습니다.");
        blank();
        sec3();
        nextText();
        System.out.println("                                 HIDDEN ENDING (3)");
        blank();
        sec3();
        nextText();
        System.out.println("                                       자본주의");
        blank();
        sec3();
        nextText();
        try {
